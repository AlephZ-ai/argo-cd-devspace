...
argocd app create $argo --repo git@github.com:AlephZ-ai/kindest-argo-cd.git --path src/$argo --dest-server https://kubernetes.default.svc --dest-namespace $argo --directory-recursegit a
