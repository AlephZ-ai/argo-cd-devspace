...
./src/scripts/k8s/create-cert-secret.sh "$KINDEST_ARGO_CD_ARGO_NAME-server-tls"
./src/scripts/k8s/create-cert-secret.sh "$KINDEST_ARGO_CD_ARGO_NAME-repo-server-tls"
./src/scripts/k8s/create-cert-secret.sh "$KINDEST_ARGO_CD_ARGO_NAME-dex-server-tls"
# https://argo-cd.readthedocs.io/en/stable/operator-manual/tls/
