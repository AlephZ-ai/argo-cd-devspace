...
while ! (kind create cluster --wait 30s --config "src/clusters/$KINDEST_ARGO_CD_CLUSTER_NAME.yaml" 2>&1); do kind delete clusters "$KINDEST_ARGO_CD_CLUSTER_NAME"; done
