...
while ! (kind create cluster --wait 30s --config "$KINDEST_ARGO_CD_PROJECT_ROOT/src/clusters/$KINDEST_ARGO_CD_CLUSTER_NAME.yaml" 2>&1); do kind delete clusters "$KINDEST_ARGO_CD_CLUSTER_NAME"; done
