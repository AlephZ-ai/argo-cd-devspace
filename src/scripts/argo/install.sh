...
./src/scripts/k8s/apply-cert-secret.sh $namespace-server-tls
./src/scripts/k8s/apply-cert-secret.sh $namespace-repo-server-tls
./src/scripts/k8s/apply-cert-secret.sh $namespace-dex-server-tls
# https://argo-cd.readthedocs.io/en/stable/operator-manual/tls/
